...
export default function HousesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Summary Section */}
      <div className="card p-5">
        <h2 className="font-semibold text-slate-900 mb-3">Inventory by (site, bed type, area)</h2>
        {summary.length === 0 ? (
      ...
      {/* Main Houses Table with Original Beautiful Pagination */}
      <div className="card p-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="font-semibold text-slate-900">All Houses</h2>
        ...
        {/* Filters */}
        <div className="flex flex-row flex-wrap items-center gap-2 mb-4 pb-4 border-b border-slate-100">
          <select className="input flex-1 min-w-[130px]" value={filterSite} onChange={(e) => setFilterSite(e.target.value)}>
            <option value="">All sites</option>
            {sites.map((s, i) => (
          ...
          <select className="input flex-1 min-w-[130px]" value={filterBed} onChange={(e) => setFilterBed(e.target.value)}>
            <option value="">All bed types</option>
        ...
        {/* === YOUR ORIGINAL BEAUTIFUL PAGINATION === */}
        {totalHouses > 0 && (
          <div className="mt-4 pt-4 border-t border-slate-100 flex flex-row items-center justify-between gap-4 text-sm text-slate-500">
            <span>
              Showing{" "}
