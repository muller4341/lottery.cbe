...
//   const [active, setActive] = useState(null); // lottery + results
...
//     () => (active?.results || []).filter((r) => r.status === 'WINNER'),
//     [active]
//   );
//   const waitlist = useMemo(
//     () => (active?.results || []).filter((r) => r.status === 'WAITLIST'),
//     [active]
//   );
...
//                     <td className="py-2 pr-3">{l.site.name}</td>
//                     <td className="py-2 pr-3"><span className="badge-blue">{l.bedType}</span></td>
//                     <td className="py-2 pr-3">{l.totalArea}</td>
//                     <td className="py-2 pr-3 text-right tabular-nums">{l.winnersCount}</td>
//                     <td className="py-2 pr-3 text-right tabular-nums">{l.waitlistCount}</td>
//                     <td className="py-2 pr-3 text-slate-500">{new Date(l.drawnAt).toLocaleString()}</td>
...
//                           href={`/api/lottery/lotteries/${l.id}/download`}
//                           target="_blank"
//                           rel="noreferrer"
...
//             {active.lottery.site.name} · {active.lottery.bedType} · {active.lottery.totalArea} m²
//           </h1>
//           <p className="text-sm text-slate-500">
//             Drawn {new Date(active.lottery.drawnAt).toLocaleString()}
//           </p>
//         </div>
//         <a
...
//           href={`/api/lottery/lotteries/${active.lottery.id}/download`}
//           target="_blank"
//           rel="noreferrer"
//           onClick={attachToken}
//         >
...
//         <KPI label="Total Houses" value={active.lottery.totalHouses} />
//         <KPI label="Total Applicants" value={active.lottery.totalApplicants} />
//         <KPI label="Winners" value={active.lottery.winnersCount} tone="emerald" />
//         <KPI label="Waitlist" value={active.lottery.waitlistCount} tone={active.lottery.waitlistCount > 0 ? 'amber' : 'slate'} />
//       </div>
...
//               <td className="py-2 pr-3 font-mono">{r.applicant.employeeId}</td>
//               <td className="py-2 pr-3">{r.applicant.fullName || '—'}</td>
//               {showHouse && (
//                 <>
//                   <td className="py-2 pr-3">{r.house?.blockNumber || '—'}</td>
//                   <td className="py-2 pr-3">{r.house?.houseNumber || '—'}</td>
//                   <td className="py-2 pr-3">{r.house?.floorNumber ?? '—'}</td>
//                 </>
//               )}
//             </tr>
//           ))}
...
// // The /api proxy on the Vite dev server already forwards the auth header for fetch/XHR.
// // For an <a href="..."> click, the browser doesn't send the Bearer header. We use fetch
// // to download as a Blob and trigger a save instead.
