...
export default function ApplicantsPage() {
  ...
  async function load() {
    ...
    try {
      ...
      let receivedApplicants = list.data.applicants || [];
      ...
      if (list.data.pagination) {
        ...
        // Slice the full list to only show the current page's chunk
        const offset = (page - 1) * limit;
        const paginatedSlice = receivedApplicants.slice(offset, offset + limit);
        setApplicants(paginatedSlice);
      }
    } catch (err) {
